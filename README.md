...
5. Terms and Conditions are accepted.
...
Test Objective:
To verify that the application shows an error when a required field is left empty.
...
Expected Result:
An inline error message, "Name is required", should appear on the Full Name field, and focus should move to it.
...
2. Leave Gender unselected and click Register.
3. Select a Gender.
4. Leave the Terms checkbox unchecked and click Register again.
...
7. Click Register to view the summary.
...
GitHub Link: "RegistrationApp GitHub Repository" (https://reference-url-citation.invalid/0)
